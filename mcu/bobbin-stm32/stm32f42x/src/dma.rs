...
::bobbin_mcu::periph!( DMA1, Dma1, DMA1_PERIPH, DmaPeriph, DMA1_OWNED, DMA1_REF_COUNT, 0x40026000, 0x00, 0x3c);
::bobbin_mcu::periph!( DMA2, Dma2, DMA2_PERIPH, DmaPeriph, DMA2_OWNED, DMA2_REF_COUNT, 0x40026400, 0x01, 0x3d);
