...
::bobbin_mcu::periph!( ADC1, Adc1, ADC1_PERIPH, AdcPeriph, ADC1_OWNED, ADC1_REF_COUNT, 0x40012000, 0x00, 0x19);
::bobbin_mcu::periph!( ADC2, Adc2, ADC2_PERIPH, AdcPeriph, ADC2_OWNED, ADC2_REF_COUNT, 0x40012100, 0x01, 0x1a);
::bobbin_mcu::periph!( ADC3, Adc3, ADC3_PERIPH, AdcPeriph, ADC3_OWNED, ADC3_REF_COUNT, 0x40012200, 0x02, 0x1b);
